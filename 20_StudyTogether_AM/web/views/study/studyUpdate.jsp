 ...
 <h2 id="openTitle">스터디 개설</h2>
         <table class="openWrite">
                 <tr>
                     ...
                     <td>스터디명<input type = "text" name = "studyName" value=""size=50> </td>
                 </tr>
                 <tr>
                     <td> 희망 지역</td>
                     <td>
                 ...
                 <tr>
                     <td>최대 인원</td>
                     <td>
                         <input type="number" min="2" max="100" name="maxMember" id="maxMember" value="">명
                     </td>
                 </tr>
                 <tr>
                     <td>모집기간</td>
...
<!-- 
                 ...
                 <tr>
                     <td>썸네일<br>이미지</td>
                     <td><input type="file" name="thumbnail" accept="image/*" value=""/></td>
                 </tr>
                 </table>
				<br>
                	<div align="center">
